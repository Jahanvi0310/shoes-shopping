...
{Object.keys(variants).includes("brown") &&
  Object.keys(variants["brown"]).includes(size) && (
    <button
      className={`border-2 border-gray-300 ml-1 bg-amber-700 rounded-full w-6 h-6 focus:outline-none ${
        color === "brown"
          ? "border-black"
          : "border-gray-300"
      }`}
  ...
  Object.keys(variants["green"]).includes(size) && (
    ...
    ></button>
        ...
        <div className="flex">
          ...
          <div className="pin mt-6 flex space-x-5 text-sm">
                <input
                  type="text"
                  className="px-2 border-2 border-cyan-500 rounded"
              ...
              {service && service != null && (
                <div className="text-green-500 text-sm mt-3">
                  Yay!!we deliver to this pincode...Lucky You!!!
                </div>
              )}
