    ...
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      ...
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <div className="flex">
          ...
          <Link href={'/Checkout'}>
          <button className="flex ml-4 text-white bg-gradient-to-r from-cyan-500 to-blue-500 border-0 py-2 px-2 md:px-6 focus:outline-none hover:bg-cyan-600 rounded">Buy Now</button></Link>
         
          <button className="flex ml-4 text-white bg-gradient-to-r from-cyan-500 to-blue-500 border-0 py-2 px-2 md:px-6 focus:outline-none hover:bg-cyan-600 rounded">Add To Cart</button>
