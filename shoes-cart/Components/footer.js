    ...
    <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      <div className="">
       ...
       ShoeMart.com
        ...
        <p>
        an outer covering for your foot that usually has a stiff bottom part called a sole with a thicker part called a heel attached to it and an upper part that covers part or all of the top of your foot. She bought a pair of shoes.
        </p>
      </div>
      <div className="">
        ...
        <p className="mb-4">
          <a href="#!" className="text-white">Sneakers</a>
        </p>
        <p className="mb-4">
          <a href="#!" className="text-white">Sport Shoes</a>
        </p>
        <p>
          <a href="#!" className="text-white">Slipers</a>
        </p>
      </div>
      <div className="">
        <h6 className="uppercase font-semibold mb-4 flex justify-center md:justify-start">
